...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7\3\2\2\21\22\7\4\2\2\22\23\7\5\2\2\23\24\7\6\2\2\24")
        buf.write("\25\5\b\5\2\25\26\7\7\2\2\26\5\3\2\2\2\27\30\7\b\2\2\30")
        buf.write("\7\3\2\2\2\31\32\7\t\2\2\32\33\5\n\6\2\33\34\7\n\2\2\34")
        buf.write("\t\3\2\2\2\35\36\7\13\2\2\36\13\3\2\2\2\2")
        return buf.getvalue()
...
class MiniDecafParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "<INVALID>", "Integer", "Whitespace", "Ident" ]
    ...
    class ReturnStmtContext(StmtContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a MiniDecafParser.StmtContext
    ...
    def stmt(self):
        ...
        try:
            localctx = MiniDecafParser.ReturnStmtContext(self, localctx)
            self.enterOuterAlt(localctx, 1)
            self.state = 23
            ...
            self.expr()
            self.state = 25
            self.match(MiniDecafParser.T__7)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
